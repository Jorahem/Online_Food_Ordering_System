...
// echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="padding: 1rem 2rem;">
//       <a class="navbar-brand" href="index.php" style="font-size: 1.5rem;">'.$systemName.'</a>
//       <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
//         <span class="navbar-toggler-icon"></span>
//       </button>

echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="padding: 1rem 1rem;"> 
      <a class="navbar-brand" href="index.php" style="font-size: 1.5rem;">'.$systemName.'</a> 
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
  ...
  echo '</div>
    ...
    if(isset($_GET['signupsuccess']) && $_GET['signupsuccess']=="true") {
      echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top: 6px;">
    ...
    if(isset($_GET['error']) && $_GET['signupsuccess']=="false") {
      echo '<div class="alert alert-warning alert-dismissible fade show" role="alert" style="margin-top: 6px;">
