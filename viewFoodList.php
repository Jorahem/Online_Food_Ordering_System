    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                // <img src="img/pizza-5.jpg" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                // <img src="img/pizza-'.$pizzaId. '.jpg" class="card-img-top" alt="image for this food" width="249px" height="270px">
        ...
        <div class="card" style="width: 18rem;">
            <img src="img/pizza-' . $pizzaId . '.jpg?version=' . time() . '" class="card-img-top" alt="image for this food" width="249px" height="270px">
            <div class="card-body">
...
echo '</form>
      <a href="viewFood.php?pizzaid=' . $pizzaId . '" class="mx-2"><button class="btn btn-primary">Quick View</button></a> 
      </div>
    </div>
  </div> 
</div>';
