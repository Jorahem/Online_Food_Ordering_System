						...
						<table class="table table-bordered table-hover mb-0">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
									...
									// <img src="/OnlineFoodDelivery/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">

                                    echo '<tr>
                                            <td class="text-center">' .$pizzaCategorieId. '</td>
                                            <td>
											 <img src="/OnlineFoodDelivery/img/pizza-' . $pizzaId . '.jpg?version=' . time() . '" class="card-img-top" alt="image for this food" width="150px" height="150px">
                                            </td>
                                            <td>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/OnlineFoodDelivery/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
